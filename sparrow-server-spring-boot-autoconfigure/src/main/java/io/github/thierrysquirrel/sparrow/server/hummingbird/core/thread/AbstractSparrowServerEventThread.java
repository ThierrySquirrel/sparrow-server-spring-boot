 ...
 **/
package io.github.thierrysquirrel.sparrow.server.hummingbird.core.thread;
...
public abstract class AbstractSparrowServerEventThread implements Runnable {
    ...
    private final SocketChannelFacade<SparrowRequestContext> ctx;
    private final SparrowRequestContext msg;

    protected AbstractSparrowServerEventThread(SocketChannelFacade<SparrowRequestContext> ctx, SparrowRequestContext msg) {
        this.ctx = ctx;
        this.msg = msg;
    }
     ...
     * @param msg msg
     */
    protected abstract void event(SocketChannelFacade<SparrowRequestContext> ctx, SparrowRequestContext msg);
