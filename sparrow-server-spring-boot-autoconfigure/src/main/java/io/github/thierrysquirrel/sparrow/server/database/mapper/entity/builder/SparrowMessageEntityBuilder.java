 ...
 **/
package io.github.thierrysquirrel.sparrow.server.database.mapper.entity.builder;
...
public class SparrowMessageEntityBuilder {
    ...
    public static SparrowMessageEntity builderSparrowMessageEntity(String topic, byte[] message) {
