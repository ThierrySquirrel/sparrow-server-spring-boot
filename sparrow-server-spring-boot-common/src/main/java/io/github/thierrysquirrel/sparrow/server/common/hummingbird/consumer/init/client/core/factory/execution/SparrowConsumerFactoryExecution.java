...
import io.github.thierrysquirrel.sparrow.server.common.hummingbird.consumer.init.client.core.factory.SparrowConsumerFactory;
...
public class SparrowConsumerFactoryExecution {
    ...
    public static void consumer(MessageListener messageListener, String url, String topic, SparrowMessage sparrowMessage) throws Exception {
        ...
        if (consumer == ConsumerState.SUCCESS) {
            ...
            SparrowConsumerFactory.confirmConsumption(topic, url, idList);
        }
    }
}
