 ...
 **/
package io.github.thierrysquirrel.sparrow.server.common.hummingbird.consumer.init.client.core.factory.execution;

import io.github.thierrysquirrel.jellyfish.thread.pool.ThreadPool;
import io.github.thierrysquirrel.sparrow.server.common.hummingbird.consumer.init.client.core.builder.container.ConsumerThreadPoolExecutorContainer;
import io.github.thierrysquirrel.sparrow.server.common.hummingbird.consumer.init.client.core.thread.execution.ConsumerThreadExecution;
...
public class ConsumerExecution {
    ...
    public static void consumer(MessageListener messageListener, String url, String topic, SparrowMessage sparrowMessage) {
        ...
        ThreadPool threadPoolExecutor = ConsumerThreadPoolExecutorContainer.getThreadPoolExecutor(topic);
